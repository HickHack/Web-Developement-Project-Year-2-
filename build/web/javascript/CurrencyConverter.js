...
function getExchangeRates(xvalue,xfrom,xto,xround) {
	if (xvalue > 0) {
		...
		document.getElementById('xxresult_'+xxdiv).innerHTML = "<span style='color: #ff0000 ;'>Calculating Rates...</span>";
...
function getExchangeRatesDiv(xxxdiv,xvalue,xfrom,xto,xround) {
	if (xvalue > 0) {
		document.getElementById(xxxdiv).innerHTML = "<span style='color: #ff0000;'>Calculating Rates...</span>";
